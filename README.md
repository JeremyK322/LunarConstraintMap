...
**Live Demo:** https://jeremyk322.github.io/LunarConstraintMap/

**Version:** Software 2.0.0.
...
The Lunar Constraint Map (LCM) makes the spatial dimension of existing legal obligations visible. It serves as a shared reference frame for international coordination, operationalising what already exists in the Outer Space Treaty framework.
...
**Extractable:** Water Ice PSR, Helium-3 Regions, Mineral and Metal Regions
...
**Orbit feature navigation:** Click any orbit feature (for example, Gateway / NRHO Orbit) in the layer menu to frame the full orbital trajectory at distance 6.5, highlight orbital satellites, and generate reports without requiring surface Lat/Lon coordinates.
...
| Dynamic Harms | Computes procedural environmental footprints for Plume Surface Interaction (PSI-v1.2), Volatile Contamination (CONTAM-v1.0), and Transient EMI (EMI-v1.1) attached to operating assets. Off by default. These models are demonstrative placeholders. They show what the layer could do when sourced from published scientific models. A production version would cite the models and publish their version numbers. |
| Disputes and Salience | When enabled, scales the visual weight of designations by evidence grade. Grade A designations render more prominently. Grade C designations render more faintly. The dispute fields in the data model (challenger, justification, response deadline) are not yet rendered in the map. They are stored in the record and will be displayed in a future version. |
...
3. Fill in the form:
   ...
   - Description
   - Notes
4. Click **Check Conflicts and Place**
5. Review the OST analysis report showing Articles 6, 9, and 11 implications
6. Confirm to place the site

### Generating Reports

1. Click on any feature on the Moon (Surface Click Selection must be enabled in Settings)
2. The popup shows name, category, tier, and meaning
3. Click **Report** for the full record
4. Reports can be printed or copied
...
| COSPAR Planetary Protection Policy | SSSI classification and protection categories |
...
The Lunar Constraint Map operationalises existing international law. It does not create new law.
...
> Kruckel, J. (2026). "Making Due Regard Visible: A Constraint Mapping Framework for Lunar Governance." Submitted to the 25th Australian Space Research Conference, Adelaide, 2026. Forthcoming in the 2027 proceedings if accepted.
...
- Source every feature with a verifiable reference
- Include evidence grade: A (direct measurement), B (regulatory), C (unverified)
- Specify review status: unassessed, under_assessment, assessed_open, assessed_protected
- Identify State responsibility under Article VI where applicable
- Note disputes and designation authority

To contribute a feature or a correction, open an issue on GitHub with the feature name, the source, and the evidence grade. Include a proposed tier and, where applicable, the responsible State Party.

---

## License

Code is licensed under the MIT License. Data is sourced from public sources and retains the license terms of the original source.
...
> Lunar Constraint Map (Version 2.0.0) [Software]. (2026). Available at: https://github.com/jeremyk322/LunarConstraintMap
...
- COSPAR for the Planetary Protection Policy and SSSI classification
- ITU for the Radio Regulations that protect the shielded zone of the Moon
